...
exports.revenueCatWebhook = exports.deleteAccount = exports.getUsageStatus = exports.runAIAction = void 0;
...
exports.deleteAccount = (0, https_1.onCall)({ region: "us-central1" }, async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError("unauthenticated", "You must be signed in.");
    }
    const uid = request.auth.uid;
        ...
        for (const field of NOTE_STORAGE_FIELDS) {
            ...
            if (typeof url === "string" &&
                ...
                try {
                    ...
                    console.warn(`deleteAccount: failed to delete storage file for note ${doc.id}:`, e);
                }
            }
        }
    }
